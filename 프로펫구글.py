...
# 데이터 로딩
file_path = r'C:\Users\user\Downloads\google_2022.xlsx'
data = pd.read_excel(file_path)

# 열 이름 확인
print(data.columns)

# 날짜 열 이름 수정 (여기서 '날짜'는 실제 날짜 열의 이름으로 바꿔야 합니다)
...
# 결과를 엑셀 파일로 저장
output_path_fixed_excel = r'C:\Users\user\Downloads\prophet_trends_2024_google_fixed.xlsx'
